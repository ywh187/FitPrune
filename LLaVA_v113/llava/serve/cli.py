...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default='/data/LLaVA/llava-v1.5-7b', required=False) # /data/LLaVA/llava-v1.5-7b
    parser.add_argument("--model-base", type=str, default=None) 
    parser.add_argument("--image-file", type=str, default="/data/LLaVA/data/scienceQA/images/test/5/image.png", required=False)
