...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="checkpoints/llava-hr-7b-sft-1024")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-folder", type=str, default="data/val2014")
    parser.add_argument("--question-file", type=str, default="data/eval/pope/llava_pope_test.jsonl")
    ...
    parser.add_argument("--reduction_ratio", type=int, default=0)
